...
public class BrowseProducts extends javax.swing.JPanel {
    ...
    private void refreshProducetable(String keyWord){
        DefaultTableModel model = (DefaultTableModel) productTable.getModel();
    ...
    private void addtoCartButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addtoCartButton6ActionPerformed
        ...
        Product selectProduct = (Product)productTable.getValueAt(row, 0);
        ...
        if(fetchQty <= selectProduct.getAvail()){
            ...
            if(!alreadyPresent){
                ...
                int newAva = oldAva-fetchQty;
                selectProduct.setAvail(newAva);
                order.addOrderItem(selectProduct, fetchQty, salesPrice );
                populateTable();
                refreshOrderTable();
            }
        }else{
    ...
    private void btnModifyQuantityActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModifyQuantityActionPerformed
        ...
        if(newQty > (currentAva+oldQty)){
            ...
            oi.getProduct().setAvail(currentAva+(oldQty-newQty));
            populateTable();
            refreshOrderTable();
    ...
    private void btnSearchProductActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchProductActionPerformed
        String proName = txtSearchKeyWord.getText();
        refreshProducetable(proName);
    ...
    private void btnRemoveOrderItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoveOrderItemActionPerformed
        ...
        OrderItem oi = (OrderItem)orderTable.getValueAt(row, 0);
        int oldAva = oi.getProduct().getAvail();
        int oldQty = oi.getQuatity();
        int newAva = oldQty+oldAva;
        oi.getProduct().setAvail(newAva);
