...
public class UF_HWQUPC_TwoLoops implements UF{
    /**
     ...
     */
    public UF_HWQUPC_TwoLoops(int n, boolean pathCompression) {
        count = n;
        parent = new int[n];
        height = new int[n];
        for (int i = 0; i < n; i++) {
     ...
     * @throws IllegalArgumentException if {@code n < 0}
     */
    public UF_HWQUPC_TwoLoops(int n) {
        this(n, true);
    }
