...
public class AdminWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private void userJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_userJButtonActionPerformed
        ...
        InfoMngJPanel imjp = new InfoMngJPanel(userProcessContainer, userAccount);
        userProcessContainer.add("InfoMngJPanel",imjp);
    ...
    private void manageEmployeeJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_manageEmployeeJButtonActionPerformed
        ...
        MenuListJPanel mljp = new MenuListJPanel(userProcessContainer, userAccount);
        userProcessContainer.add("AdminWorkAreaJPanel",mljp);
        CardLayout layout = (CardLayout)userProcessContainer.getLayout();
        layout.next(userProcessContainer);
    ...
    private void manageOrganizationJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_manageOrganizationJButtonActionPerformed
        ...
        OrderMngJPanel omjp = new OrderMngJPanel(userProcessContainer, userAccount,business);
        userProcessContainer.add("OrderMngJPanel",omjp);
        CardLayout layout = (CardLayout)userProcessContainer.getLayout();
        layout.next(userProcessContainer);
